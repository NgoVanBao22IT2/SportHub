 ...
 * Redirects unauthenticated users to /login and renders 403 / redirect for unauthorized roles.
 */
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-900 text-white">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-slate-400 text-sm font-medium">Đang kiểm tra phiên đăng nhập...</p>
        </div>
      </div>
    );
  }
