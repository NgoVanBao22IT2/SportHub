...
export default function BlockSlotModal({
  ...
  const calculateEndTime = () => {
    ...
    if (blockScope === '1_HOUR') {
      ...
      h += 2;
    } else if (blockScope === '12_HOURS') {
      h += 12;
    } else if (blockScope === '24_HOURS') {
      h += 24;
    } else {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="1_HOUR">Khóa 1 giờ </option>
              <option value="2_HOURS">Khóa 2 giờ </option>
              <option value="12_HOURS">Khóa 12 giờ </option>
              <option value="24_HOURS">Khóa 24 giờ </option>
              <option value="LONG_TERM">Cho tới khi chủ sân mở lại</option>
            </select>
          </div>
